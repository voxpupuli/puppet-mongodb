...
class mongodb::server (
  ...
  $ldap_enable                = undef,
  $ldap_servers               = undef,
  $ldap_authz_querytemplate   = undef,
  $ldap_bind_queryUser        = undef,
  $ldap_bind_queryPassword    = undef,
  $ldap_bind_method           = undef,
  $ldap_bind_saslmechanisms   = undef,
  $ldap_bind_useosdefaults    = undef,
  $ldap_transportSecurity     = undef,
  $ldap_usertodnmapping       = undef,
