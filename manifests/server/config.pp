...
class mongodb::server::config {
  ...
  $ldap_servers              = $mongodb::server::ldap_servers
  $ldap_authz_querytemplate  = $mongodb::server::ldap_authz_querytemplate
  $ldap_bind_queryUser       = $mongodb::server::ldap_bind_queryUser
  $ldap_bind_queryPassword   = $mongodb::server::ldap_bind_queryPassword
  $ldap_bind_method          = $mongodb::server::ldap_bind_method
  $ldap_bind_saslmechanisms  = $mongodb::server::ldap_bind_saslmechanisms
